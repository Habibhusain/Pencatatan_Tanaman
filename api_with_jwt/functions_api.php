<?php
    ...
    function tambah_tanaman($tanggal,$tanaman, $keterangan,$foto,$id_user)
    {

        $tambah_data_tanaman = "INSERT INTO tanaman (tanggal,tanaman,keterangan,foto,id_user) VALUES ('$tanggal', '$tanaman', '$keterangan', '$foto','$id_user')";
